...
//
//  Modified by Oleksii Kozlov on 17.11.11.
//
//  Replaced return shared##__CLASSNAME__; with
//  __CLASSNAME__ *instance = (__CLASSNAME__ *)shared##__CLASSNAME__; return instance;
//
//  Replaced (void)release with (oneway void)release.
//
...
\
__CLASSNAME__ *instance = (__CLASSNAME__ *)shared##__CLASSNAME__;  \
return instance;	\
}	\
\
+ (void)purgeShared##__CLASSNAME__\
